...
sink("~/bear/Res/Types/ResProc90_lr1.txt")
summary(lr1.proc)
...
sink("~/bear/Res/Types/ResProc90_lr2.txt")
summary(lr2.proc)
...
write.xlsx(cos1.proc, "~/bear/Res/Types/coefs1_Proc90.xlsx")
cos2.proc <- exp(lr2.proc$finalModel$coefficients)
write.xlsx(cos2.proc, "~/bear/Res/Types/coefs2_Proc90.xlsx")
...
sink("~/bear/Res/Types/ResIo90_lr1.txt")
summary(lr1.io)
...
sink("~/bear/Res/Types/ResIo90_lr2.txt")
summary(lr2.io)
...
write.xlsx(cos1.io, "~/bear/Res/Types/coefs1_Io90.xlsx")
cos2.io <- exp(lr2.io$finalModel$coefficients)
write.xlsx(cos2.io, "~/bear/Res/Types/coefs2_Io90.xlsx")
