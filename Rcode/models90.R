...
trainIndex <- createDataPartition(dat90$y, p = .8,
                                  list = FALSE,
                                  times = 1)
training <- dat90[trainIndex,]
test <- dat90[-trainIndex,]
...
# Now that the models are done running, I computed and analyzed the results.
 ...
 sink("/Users/ruimin/Dropbox/bear/Res/Res90_lr.txt")
 summary(lr)
 confusionMatrix(lr)
 varImp(lr)
 ...
 sink("/Users/ruimin/Dropbox/bear/Res/Res90_lr1.txt")
 summary(lr1)
 confusionMatrix(lr1)
 varImp(lr1)
 ...
 sink("/Users/ruimin/Dropbox/bear/Res/Res90_lr2.txt")
 summary(lr2)
 confusionMatrix(lr2)
 varImp(lr2)
 ...
 write.xlsx(cos, "/Users/ruimin/Dropbox/bear/Res/coefs_90.xlsx")
 
 library(xlsx)
 cos1 <- exp(lr1$finalModel$coefficients)
 write.xlsx(cos1, "/Users/ruimin/Dropbox/bear/Res/coefs1_90.xlsx")
 cos2 <- exp(lr2$finalModel$coefficients)
 write.xlsx(cos2, "/Users/ruimin/Dropbox/bear/Res/coefs2_90.xlsx")
