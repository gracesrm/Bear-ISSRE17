...
library(MASS)
tbl = table(ddat$y, ddat$syscall)
tbl1= table(ddat$y, ddat$stratNo)
...
ddat.proc <- ddat.proc[which(ddat.proc$thresh == '90'),]
ddat.io <- rbind(ddat.net, ddat.ds)
ddat.io <- ddat.io[which(ddat.io$thresh == '90'),]

tbl = table(ddat.io$y, ddat.io$syscall)
tbl1= table(ddat.io$y, ddat.io$stratNo)

chisq.test(tbl) 
chisq.test(tbl1) 


ddat10 <- ddat.pr[which(ddat.pr$thresh == '90'),]
# ------------ds---------
rm(tbl, tbl1)
tbl = table(ddat.ds$y, ddat.ds$syscall)
tbl1= table(ddat.ds$y, ddat.ds$stratNo)
chisq.test(tbl) 
chisq.test(tbl1) 
# ------------net---------
rm(tbl, tbl1)
tbl = table(ddat.net$y, ddat.net$syscall)
tbl1= table(ddat.net$y, ddat.net$stratNo)
chisq.test(tbl) 
chisq.test(tbl1) 
# ------------proc---------
rm(tbl, tbl1)
tbl = table(ddat.proc$y, ddat.proc$syscall)
tbl1= table(ddat.proc$y, ddat.proc$stratNo)
chisq.test(tbl) 
chisq.test(tbl1) 
...
sink("/Users/ruimin/Dropbox/bear/Res/Types/ResProc10_lr1.txt")
summary(lr1.proc)
...
sink("/Users/ruimin/Dropbox/bear/Res/Types/ResProc10_lr2.txt")
summary(lr2.proc)
...
write.xlsx(cos1.proc, "/Users/ruimin/Dropbox/bear/Res/Types/coefs1_Proc10.xlsx")
cos2.proc <- exp(lr2.proc$finalModel$coefficients)
write.xlsx(cos2.proc, "/Users/ruimin/Dropbox/bear/Res/Types/coefs2_Proc10.xlsx")
...
sink("/Users/ruimin/Dropbox/bear/Res/Types/ResIo10_lr1.txt")
summary(lr1.io)
...
sink("/Users/ruimin/Dropbox/bear/Res/Types/ResIo10_lr2.txt")
summary(lr2.io)
...
write.xlsx(cos1.io, "/Users/ruimin/Dropbox/bear/Res/Types/coefs1_Io10.xlsx")
cos2.io <- exp(lr2.io$finalModel$coefficients)
write.xlsx(cos2.io, "/Users/ruimin/Dropbox/bear/Res/Types/coefs2_Io10.xlsx")
