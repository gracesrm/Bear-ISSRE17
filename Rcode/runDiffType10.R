...
sink("~/bear/Res/Types/ResProc10_lr1.txt")
summary(lr1.proc)
...
write.xlsx(cos1.proc, "~/bear/Res/Types/coefs1_Proc10.xlsx")
cos2.proc <- exp(lr2.proc$finalModel$coefficients)
write.xlsx(cos2.proc, "~/bear/Res/Types/coefs2_Proc10.xlsx")
...
sink("~/bear/Res/Types/ResIo10_lr1.txt")
summary(lr1.io)
...
sink("~/bear/Res/Types/ResIo10_lr2.txt")
summary(lr2.io)
...
write.xlsx(cos1.io, "~/bear/Res/Types/coefs1_Io10.xlsx")
cos2.io <- exp(lr2.io$finalModel$coefficients)
write.xlsx(cos2.io, "~/bear/Res/Types/coefs2_Io10.xlsx")
